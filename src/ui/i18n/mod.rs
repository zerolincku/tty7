...
l10n_keys! {
    ...
    SettingsShareConnection,
    SettingsShareMissingPassword,
    SettingsShareOnce,
    SettingsShareSave,
    SettingsShareKey,
    SettingsShareCopied,
    SettingsShareKeyCopied,
    SettingsShareError,
    SettingsSharePasswordRequired,
    SettingsShareText,
    SettingsShareKeyText,
    SettingsRenameSshGroup,
    SettingsDeleteSshGroup,
    SettingsDeleteSshGroupBody,
    SettingsCreateSshGroup,
    SettingsMoveSshGroup,
    SettingsSshGroupName,
    SettingsSshGroup,
    SettingsSshGroupInvalid,
    SettingsCreateSshGroupAction,
    SettingsCopyAddress,
    SettingsDuplicate,
