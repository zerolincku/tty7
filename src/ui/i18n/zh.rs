...
pub fn translate_zh(key: L10nKey) -> Option<&'static str> {
    Some(match key {
        L10nKey::HostSystemType => "系统类型",
        L10nKey::HostDirectory => "目录",
        L10nKey::HostAuthMode => "SSH 认证模式",
        L10nKey::HostAuthHint => "显示连接配置；免密能力未单独验证。",
        L10nKey::HostOverview => "系统概览",
        L10nKey::HostRefresh => "刷新",
        L10nKey::HostCollecting => "采集中…",
        L10nKey::HostCores => "逻辑核",
        L10nKey::HostUptime => "运行时间",
        L10nKey::HostLoad => "负载 1 / 5 / 15 分钟",
        L10nKey::HostSystemDetails => "内核与处理器",
        L10nKey::HostKernel => "内核",
        L10nKey::HostResources => "资源",
        L10nKey::HostMemory => "内存",
        L10nKey::HostAvailable => "可用",
        L10nKey::HostUsed => "已用",
        L10nKey::HostDisk => "磁盘",
        L10nKey::HostMounts => "挂载点详情",
        L10nKey::HostDisksUnavailable => "未能读取磁盘信息",
        L10nKey::HostEnvironment => "软件安装",
        L10nKey::HostVersions => "版本与检测详情",
        L10nKey::HostNodeDetection => "Kubernetes 仅检测本机节点组件。",
        L10nKey::HostCollectFailed => "采集失败，可重试",
        L10nKey::HostUpdated => "距上次更新",
        L10nKey::HostStale => "刷新失败，保留上次结果",
        L10nKey::HostReady => "可用",
        L10nKey::HostRestricted => "无权限",
        L10nKey::HostMissing => "未安装",
        L10nKey::HostInstalled => "已安装",
        L10nKey::HostUndetected => "未检测到",
        L10nKey::HostUnavailable => "服务不可用",
        L10nKey::HostUnknown => "未确认",
        L10nKey::HostPorts => "端口与转发",
